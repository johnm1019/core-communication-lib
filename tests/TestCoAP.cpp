...
SUITE(CoAP)
{
  ...
  {
    uint8_t expected[16] = {
      0x4d, 0x6d, 0xb5, 0xb7, 0x90, 0x19, 0xec, 0x35,
      0xf1, 0x02, 0x21, 0x0f, 0x5f, 0x67, 0x0f, 0x6f };
    unsigned char buf[16];
    memset(buf, 0, 16);
    init();
  ...
  {
    uint8_t expected[32] = {
      0xbd, 0x5c, 0x41, 0x74, 0xd8, 0x18, 0xfe, 0xde,
      0xa8, 0x24, 0xcf, 0xaf, 0x8c, 0x32, 0x97, 0x9e,
      0xb2, 0x33, 0x5b, 0xc8, 0x82, 0xcc, 0x47, 0x3a,
      0x03, 0xc6, 0xbb, 0xf6, 0xa5, 0x05, 0xae, 0x27 };
    unsigned char buf[32];
    memset(buf, 0, 32);
    init();
  ...
  {
    uint8_t expected[32] = {
      0xb7, 0xfe, 0x2b, 0xfa, 0x3d, 0xb4, 0x45, 0x86,
      0x54, 0x01, 0x43, 0xe0, 0x2a, 0xa3, 0xd7, 0xf0,
      0x49, 0x8f, 0xf3, 0x8f, 0x8c, 0x95, 0xfe, 0xc1,
      0x02, 0x80, 0x4a, 0x1a, 0x53, 0x2e, 0x00, 0xcc };
    unsigned char buf[32];
    memset(buf, 0, 32);
    init();
    const char *fnames[1];
